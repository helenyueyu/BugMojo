...
class AnswereeBox extends React.Component {
    constructor(props) {
        super(props);
    }

    render() {
        if (this.props.answer && this.props.image) {
            return (
                <div className="answeree_box">
                    <div className="askee_box_time">asked {moment(this.props.answer.createdAt).fromNow()}</div>
